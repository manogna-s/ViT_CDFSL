...
class MetaDatasetReader(object):
    def __init__(self, mode, train_set, validation_set, test_set, config_file):
...
class MetaDatasetEpisodeReader(MetaDatasetReader):
    ...
    """
    def __init__(self, mode, train_set=None, validation_set=None, test_set=None, config_file=None):
        super(MetaDatasetEpisodeReader, self).__init__(mode, train_set, validation_set, test_set, config_file)
...
class MetaDatasetBatchReader(MetaDatasetReader):
    ...
    Class that wraps the Meta-Dataset episode readers.
    """
    def __init__(self, mode, train_set, validation_set, test_set, batch_size, config_file):
        super(MetaDatasetBatchReader, self).__init__(mode, train_set, validation_set, test_set, config_file)
